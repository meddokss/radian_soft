...
;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;s>e;e++)if("object"==typeof o||void 0===o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),void 0!==n)return n;return i}}),$(function(){function e(e,t){var n=parseInt($(window).width(),10);return $("body").addClass("ov-h"),$(e).addClass("is-active"),$("#menu-mobile").addClass("open_menu"),$("#menu-mobile").css({left:"0px"}),$("#menu-mobile-second").addClass("open_menu"),t?$("#menu-mobile-second").animate({left:"0px"},400):$("#menu-mobile-second").css({left:n+"px"}),!1}function t(e){return $("body").removeClass("ov-h"),$(e).removeClass("is-active"),$("#menu-mobile").removeClass("open_menu"),$("#menu-mobile-second").removeClass("open_menu"),!1}function n(){var e=parseInt($(window).width(),10);return $("#menu-mobile-second").animate({left:e+"px"},300),$("#menu-mobile ul li").removeClass("active"),setTimeout(function(){$("#menu-mobile-second").css({display:"none"}),$("#menu-mobile-second").css({position:"relative"})},1e3),!1}function i(){$(".modalDialog").addClass("open")}function o(){$(".modalDialog").removeClass("open")}function r(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"#section-1";if($(window).width()>1024){var t=window.innerHeight,n=$(e).children(".wedo__content").innerHeight();n+105>=t?$(".wrap").height(n+200):$(".wrap").height(t)}else $(window).width()<=1024&&$(window).width()>700?$(".wrap").height($(e).innerHeight()):$(".wrap").height("auto")}function s(){null!==p.getAnimation()?p.setAnimation(null):p.setAnimation(google.maps.Animation.BOUNCE)}function a(){var e=$(document).scrollTop();$(".animate_block")&&$(".animate_block").each(function(){e>$(this).offset().top-$(window).height()/1.15&&$(this).addClass("animate")})}var l=!1;$("body").addClass("loaded"),$("#second_menu").on("click",function(){$("#menu-mobile-second").css({position:"fixed"}),$("#menu-mobile-second").css({display:"flex"}),$("#menu-mobile-second").animate({left:"0px"},300),$("#menu-mobile-second").css({zIndex:"20"}),l=!0}),$("#menu-mobile ul li").on("click",function(){$("ul li").removeClass("active"),$(this).addClass("active")}),$("#menu-mobile-second ul li").on("click",function(){$("ul li").removeClass("active"),$(this).addClass("active")}),$(".back").on("click",n),$("#open").on("click",i),$("#close").on("click",o),$("#hamburger").on("click",function(){$(this).hasClass("is-active")?(t(this),n()):e(this)}),$(window).on("resize",function(){var i=parseInt($(window).width(),10);i>=767&&$("#hamburger").hasClass("is-active")&&(t($("#hamburger")),$("#menu-mobile-second").css({display:"none"}),n()),i<765&&$("#hamburger").hasClass("is-active")&&e($("#hamburger"),l)}),$(document).on("keyup",function(e){27===e.which&&$("#hamburger").hasClass("is-active")&&(t($("#hamburger")),n()),27===e.which&&$(".modalDialog").hasClass("open")&&o(),8===e.which&&n(),e.preventDefault(),e.stopPropagation()}),r(),$("ol.sl li").on("click",function(){var e=$(this).attr("data-tab"),t=parseInt(e[e.length-1]),n=$("#"+e),i={1:"active-1",2:"active-2",3:"active-3",4:"active-4",5:"active-5"};jQuery.each(i,function(e,t){$(".wrap").removeClass(t)}),$(".wrap").addClass(i[t]),$(".active_desc > .wedo__content > .title").removeClass("move_up"),$(".active_desc > .wedo__content > .text").removeClass("move_text"),$(".active_desc > .wedo__content > .shest").removeClass("move_down"),$(".description").removeClass("active_desc"),$("#"+e).addClass("active_desc"),$(".active_desc > .wedo__content > .title").addClass("move_up"),$(".active_desc > .wedo__content > .text").addClass("move_text"),$(".active_desc > .wedo__content > .shest").addClass("move_down"),$("ol.sl li").removeClass("active_red"),$(this).addClass("active_red"),$(".active_desc").hasClass("bg_grey")?$(".wedo").addClass("grey"):$(".wedo").removeClass("grey"),r(n)}),$(window).on("resize",function(){var e=parseInt($(window).width(),10),t=$("ol.sl li.active_red").attr("data-tab"),n=$("#"+t);$(".active_desc").hasClass("bg_grey")&&e>700?$(".wedo").addClass("grey"):$(".wedo").removeClass("grey"),r(n)});var c=$(".responsive"),d={dots:!1,infinite:!1,speed:300,slidesToShow:1,slidesToScroll:1,adaptiveHeight:!0,responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0,dots:!1}},{breakpoint:603,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0,dots:!1}}]};c.slick(d),$(window).on("resize",function(){return $(window).width()<605?void(c.hasClass("slick-initialized")&&c.slick("unslick")):c.hasClass("slick-initialized")?void 0:c.slick(d)}),$(".back_top").on("click",function(){$("body").animate({scrollTop:0},"slow")}),$(window).on("scroll",function(){a(),console.log(1),($(window).scrollTop()||$("body").scrollTop())>=1200&&$(".svg").addClass("move")}),$(document).on("scrollstart",function(){a()});var u=void 0,p=void 0,f=($(window).width(),"img/marker.svg"),h=[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}];$(".contact_map_adr").on("click",function(){$(this).hasClass("odessa")&&u.setCenter({lat:38.871053,lng:-77.056298})}),function(){u=new google.maps.Map(document.getElementById("map"),{zoom:15,styles:h,center:{lat:38.871053,lng:-77.056298}}),p=new google.maps.Marker({map:u,zoom:20,maxZoom:25,title:"RADIAN",animation:google.maps.Animation.DROP,position:{lat:38.871053,lng:-77.056298},icon:f}),p.addListener("click",s)}(),s(),function(){$(".animate_onload")&&$(".animate_onload").each(function(){$(this).addClass("animate")})}(),function(){var e=[],t=$(document).scrollTop();$(".animate_block").map(function(t,n){$(n).offset().top<=window.innerHeight/1.15&&e.push(n)}),e.forEach(function(e){$(e).addClass("animate")}),t>100&&a()}()});